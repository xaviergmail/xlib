...
local debug_setlocal = debug.setlocal or function() ErrorNoHalt("debug.setlocal is missing. You should install the binary files provided in the XLIB repo.\n") end
...
local win = gmod and system.IsWindows() or (os and os.getenv and (os.getenv('WINDIR') or (os.getenv('OS') or ''):match('[Ww]indows')) and true or false)
local mac = gmod and system.IsOSX() or (not win and (os and os.getenv and os.getenv('DYLD_LIBRARY_PATH') or not io.open("/proc")) and true or false)
